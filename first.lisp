...
;;; Задание 33
;;; Соболев
;;; Создать функцию, преобразующую список в множество
;;;
(defun Вхождение_Элемента (x lst)
    (cond
        ((null lst) nil)
        ((equal x (car lst)) (return-from Вхождение_Элемента t))
        (t (Вхождение_Элемента
 x(cdr lst)))))
(defun Список (lst)
    ((lambda (head tail) 
       (cond
           ((null lst) nil)
           ((not (Вхождение_Элемента head tail)) (cons head (Список tail)))
           (t (Список tail))))
        (car lst) (cdr lst)))
;;; (Список '((1 1 2 1 3 1 2 1 3 3 3 2 1))
;;; (3 2 1)
;;; (Список '(1 1 1 1 2 2 1 2 1 2 2 1 1 1 2 1 3 1 2 4 1 26 2))
;;; (3 4 1 26 2)
;;;	-------------------------------------------------------------
;;; Задание 12
;;; Соболев
